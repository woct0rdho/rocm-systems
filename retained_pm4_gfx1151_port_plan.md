...
- Binary: `~/llama.cpp/build/bin/llama-bench`, llama.cpp `e2d322f07` (`0.4.1-dev`, build 11086).
- Runtime: fork-patched HIP `7.16.26374-f39ab5add8` built from `~/rocm-systems` `902eb3f26c` (retained-PM4 port `16b938f6e1`).
...
| --- | ---: | ---: | ---: |
| `pp512` | 1474.78 +/- 15.76 | 1507.82 +/- 32.14 | +2.24% |
| `pp2048` | 1468.18 +/- 4.70 | 1481.75 +/- 8.38 | +0.92% |
| `tg128` | 59.07 +/- 0.09 | 69.42 +/- 0.20 | +17.52% |
| `tg512` | 59.11 +/- 0.04 | 69.60 +/- 0.03 | +17.75% |
...
```text
[hipGraph][PM4] retained 3194 dispatches in 94117 dwords, max private 1264 bytes
[hipGraph][PM4] retained 1704 dispatches in 51037 dwords, max private 24 bytes
[hipGraph][PM4] retained 1644 dispatches in 49357 dwords, max private 24 bytes
```
...
| Workload | PM4 disabled | PM4 enabled | Change |
| --- | ---: | ---: | ---: |
| `pp512` | 235.07 +/- 2.56 | 235.99 +/- 1.77 | +0.39% |
| `pp2048` | 227.37 +/- 0.44 | 227.39 +/- 0.55 | +0.01% |
| `tg128` | 15.53 +/- 0.02 | 17.72 +/- 0.02 | +14.10% |
| `tg512` | 15.48 +/- 0.00 | 17.64 +/- 0.01 | +13.95% |

A diagnostic run with PM4 enabled and `AMD_LOG_LEVEL=3` confirmed retained execution for this larger model:

```text
[hipGraph][PM4] retained 5869 dispatches in 172015 dwords, max private 100 bytes
[hipGraph][PM4] retained 4719 dispatches in 135255 dwords, max private 0 bytes
```
