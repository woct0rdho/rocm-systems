 ...
 */
HIP_TEST_CASE(Performance_GraphTopology_Straight) {
  TestOptions opt;
 ...
 */
HIP_TEST_CASE(Performance_GraphTopology_Parallel) {
  TestOptions opt;
 ...
 */
HIP_TEST_CASE(Performance_GraphTopology_Hexagon) {
  TestOptions opt;
 ...
 */
HIP_TEST_CASE(Performance_GraphTopology_Mixed) {
  TestOptions opt;
  opt.topology = "mixed";
